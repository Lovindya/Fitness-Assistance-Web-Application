...
function ready(){
  ...
  var addCart = document.getElementsByClassName("product-btns");
...
function buyButtonClicked(event){
  ...
  updateTotal();
  document.location.href = "D:\RGU\web tech\CW\cw\std3\placeOrder pg\placeOrder.html";
}
...
function addCartClicked(event){
  ...
  var title = buyProducts.querySelector(".product-name").innerText;
  var price = buyProducts.querySelector(".product-price").innerText;
  var productImg = buyProducts.querySelector(".product-image").src;
...
function addProductToCart(title, price, productImg) {
  ...
  var cartBoxContent = `<img src="${productImg}" alt="PS5" class="cart-img">
